...
infernoData :: Vector (Double, Double, Double)
...
plasmaData :: Vector (Double, Double, Double)
plasmaData = V.fromList
...
viridisData :: Vector (Double, Double, Double)
viridisData = V.fromList
